...
# Helper functions for styled text boxes
...
def main():
    ...
    # Sidebar for user inputs and model parameters
    with st.sidebar:
    ...
    # Prepare features and target based on user choice
    ...
    # Calculate and display feature importances for tree-based models
